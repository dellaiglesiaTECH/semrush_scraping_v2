...
driver.find_element(By.XPATH,'//*[@id="root"]/div/div/div[3]/div/section/div/div[1]/div[1]/div/div').click()
countries_driver=driver.find_elements(By.XPATH,'//*[@id="ui-kit-635902"]/div/div/div/div/div[1]/div')
time.sleep(10)
...
driver.find_element(By.XPATH,'//*[@id="root"]/div/div/div[3]/div/section/div/div[1]/div[2]/div/div/div[1]').click()
categories_driver=driver.find_elements(By.XPATH,'//*[@id="ui-kit-635903"]/div/div/div/div/div[1]/div')
...
print(categories)
mon_year=driver.find_element(By.XPATH,'//*[@id="root"]/div/div/div[4]/div/h1').text.split(', ')[1]
